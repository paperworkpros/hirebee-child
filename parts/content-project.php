...
<article id="project-<?php echo $project_id; ?>" <?php ( is_hrb_project_featured() ? post_class( 'project featured' ) : post_class( 'project' ) ); ?>>

	<?php appthemes_before_post_title( HRB_PROJECTS_PTYPE ); ?>

	<h2 class="archive-project-title"><?php the_hrb_project_title(); ?>
		<?php
		if ( is_hrb_project_featured() ) {
			the_hrb_project_addons( 0, '<span class="add-ons">', '</span>' );
		}
		?>
	</h2>
		...
		<div class="budget-deadline">
			<div class="project-budget-wrapper">
				<div class="project-budget">
					<span class="budget"><?php echo $budget_range; ?></span>
		...
		<div class="project-content cf">
			<div class="row collapse project-author-meta">
				<div class="large-8 small-6 columns">
					<span class="project-author-by"><i class="icon i-author"></i><?php the_hrb_project_author( $project_id, __( 'by ', APP_TD ) ); ?></span>
			...
			<div class="project-description">
				...
				<div class="project-date"><i class="icon i-post-date"></i><?php the_hrb_project_posted_time_ago(); ?>
				</div>
			</div>
	...
	<div class="project-meta-below-desc cf">
		...
		<div class="project-cat">
			<i class="icon i-project-category"></i> <?php the_hrb_tax_terms( HRB_PROJECTS_CATEGORY ); ?></div>
		<div class="project-skills"><?php the_hrb_tax_terms( HRB_PROJECTS_SKILLS, $project_id, ' ', '<span class="label">', '</span>' ); ?></div>
	</div>
